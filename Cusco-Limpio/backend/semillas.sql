...
FROM (VALUES
  ('San Blas', 'Mañana', TIME '06:00', TIME '07:00', 'Todos los dias'),
  ...
  ('San Cristóbal', 'Mañana', TIME '06:30', TIME '07:15', 'Lun, Dom'),
  ...
  ('Zaguán del Cielo', 'Mañana', TIME '07:15', TIME '08:00', 'Mar, Jue, Sab'),
